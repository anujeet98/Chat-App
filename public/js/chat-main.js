...
async function createGroupAPI(groupName, groupDescription, selectedUserList){
    try{
        ...
        return await axios.post('http://localhost:4000/group/create-group/', grpObj, {headers: {'Authorization': localStorage.getItem('token')}});
    }
    catch(err){
        if(err){
...
async function getGroupInfoAPI(){
    try{
        return await axios.get(`http://localhost:4000/group/get-info?groupId=${selectedGroup}`, {headers: {"Authorization": localStorage.getItem("token")}});
    }
    catch(err){
        if(err){
            alert(err.response.data.message);
...
async function fetchAllUsersAPI(){
    try{
        return axios.get('http://localhost:4000/user/get-users', {headers: {"Authorization": localStorage.getItem("token")}});
    }
    catch{
        if(err){
            alert(err.response.data.message);
...
async function getUserGroupsAPI(){
    try{    
        return await axios.get('http://localhost:4000/user/groups', {headers: {'Authorization': localStorage.getItem('token')}});
    }
    catch(err){
        if(err){
            alert(err.response.data.message);
...
async function addGroupAdmin(groupId, memberId){
    try{
        ...
        const response = await axios.put(`http://localhost:4000/group/add-admin`, reqObj, {headers: {'Authorization': localStorage.getItem('token')}});
        generateEditGroup();
    }
    catch(err){
        if(err){
...
async function removeGroupAdmin(groupId, memberId){
    try{
        ...
        const response = await axios.put(`http://localhost:4000/group/remove-admin`, reqObj, {headers: {'Authorization': localStorage.getItem('token')}});
        generateEditGroup();
    }
    catch(err){
        if(err){
...
async function removeUser(groupId, memberId){
    try{
        const response = await axios.delete(`http://localhost:4000/group/remove-user?memberId=${memberId}&groupId=${groupId}`, {headers: {'Authorization': localStorage.getItem('token')}});
        generateEditGroup();
    }
    catch(err){
        if(err){
...
async function updateGroupAPI(groupName, groupDescription){
    try{
        ...
        return await axios.put('http://localhost:4000/group/update', reqObj, {headers: {'Authorization': localStorage.getItem('token')}});
    }
    catch(err){
        if(err){
            alert(err.response.data.message);
...
async function addUsersAPI(selectedUsers){
    try{      
        ...
        return await axios.post('http://localhost:4000/group/add-users/', reqObj, {headers: {'Authorization': localStorage.getItem('token')}});
    }
    catch(err){
        if(err){
            alert(err.response.data.message);
